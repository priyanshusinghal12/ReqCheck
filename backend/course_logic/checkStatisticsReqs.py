...
def check_stats_major(student_courses):
  ...
  refine_courses(student_courses, ["MATH 237", "MATH 247", "ENGL 378", "MTHEL 300", "MATH 239", "MATH 249"])

  stat_reqs = {
    "Complete all of: STAT 330, STAT 331, STAT 332, STAT 333": [False, []],
    ...
    "Complete either 1 additional STAT 400-level course or one of: CS 457, CS 485, CS 486": [False, []],
  ...
  check_complete_all("Complete all of: STAT 330, STAT 331, STAT 332, STAT 333",
  ...
  check_n_from_list("Complete either 1 additional STAT 400-level course or one of: CS 457, CS 485, CS 486",
                    required_courses = ["CS 457", "CS 485", "CS 486"],
                    n = 1,
                    student_courses = student_courses,
                    major_reqs = stat_reqs)

  if not stat_reqs["Complete either 1 additional STAT 400-level course or one of: CS 457, CS 485, CS 486"][0]:
    check_n_courses("Complete either 1 additional STAT 400-level course or one of: CS 457, CS 485, CS 486",
                    eligible_levels = 400,
                    subject_codes = ["STAT"],
                    n = 1,
                    student_courses = student_courses,
