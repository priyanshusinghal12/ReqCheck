...
const SERVICE_ID = "service_8kul95f";
const TEMPLATE_ID = "template_5nwpp98";
const PUBLIC_KEY = "QfA7nftTjw6l-Bpnq";
			...
			{!submitted ? (
				...
				<div className="text-center max-w-xl px-4">
					...
					<p className="text-lg text-gray-300">
						We truly appreciate your feedback and are always looking for ways to
						improve. Your thoughts help shape the future of ReqCheck!
					</p>
				</div>
			)}
		</div>
